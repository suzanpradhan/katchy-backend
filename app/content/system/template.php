...
<body>
  <div class="c20 center-box">
    <header id="header">
      <div id="logo"><img src="<?php echo G\absolute_to_url(CHV_APP_PATH_CONTENT_SYSTEM . 'katchy.png'); ?>" alt=""></div>
    </header>
    <div id="content">
      <?php echo $html; ?>
    </div>
    <div id="powered">&copy; <a href="http://katchy.com">katchy image hosting script</a></div>
  </div>
</body>
...
if (method_exists('CHV\Settings', 'getkatchy')) {
  echo '<script>var katchy = ' . json_encode(CHV\Settings::getkatchy()) . '</script>';
}
?>
<script defer data-cfasync="false" src="<?php echo CHV\Render\versionize_src(G\Render\get_app_lib_file_url('katchy.js')); ?>" id="katchy-js"></script>
<script data-cfasync="false">
  document.getElementById("katchy-js").addEventListener("load", function() {
