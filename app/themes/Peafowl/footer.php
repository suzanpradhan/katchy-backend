...
?>
	...
	<div data-modal="form-upgrade" class="hidden" data-is-xhr data-submit-fn="CHV.fn.submit_upgradeToPaid" data-ajax-deferred="CHV.fn.complete_upgradeToPaid">
		<span class="modal-box-title">🚀 Upgrade katchy</span>
		<p>Upgrading to paid katchy enables more <a href="https://katchy.com/features" target="_blank">features</a> like multiple external storage servers, manage banners, content likes, user followers, social login signup, and early access to all new stuff. Tech Support is included, of course.</p>
		<p>Keep in mind that katchy is made <b>by a single developer</b>, your purchase helps to sustain ongoing development of this software.</p>
		<p>You can upgrade now by pasting your <a href="https://katchy.com/panel/license" target="_blank">license key</a>. If you don't have one you can <a href="https://katchy.com/pricing" target="_blank">buy it now</a> with PayPal, AliPay, UnionPay and crypto.</p>
