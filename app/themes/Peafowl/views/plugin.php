...
<div class="center-box c24">
	<div class="content-width">
		...
		<div class="text-content">
			...
			<div><?php echo get_plugin()['stylesheet'];
					echo get_plugin()['button']; ?></div>
	...
	$(function() {
		...
		$(document).on("change", "#palette", function(e) {
			...
			$pluginButton.removeClass(function(i, className) {
				return (className.match(/(^|\s)katchy-pup-button--palette-\S+/g) || []).join(' ');
			}).addClass('katchy-pup-button--palette-' + val);
		});
	});
</script>