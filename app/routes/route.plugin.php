...
$route = function ($handler) {
    try {
        ...
        $plugin = [
            ...
            'tagCode' => $tagCode,
            'table' => [
                '%cClass' => 'katchy-pup-container',
                '%bClass' => 'katchy-pup-button',
                '%iClass' => 'katchy-pup-button-icon',
        ...
        $plugin['stylesheet'] = '<style type="text/css" id="katchy-pup-style">' . $plugin['baseCss'] . $palette_css_rules . '</style>';
