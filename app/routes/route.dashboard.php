...
$route = function ($handler) {
    try {
        ...
        $handler::setVar('documentationBaseUrl', 'https://v3-docs.katchy.com/');
        ...
        switch ($doing) {
            ...
            case 'stats':
                ...
                $chv_version = [
                    ...
                    'db'    => CHV\getSetting('katchy_version_installed')
                ];
                ...
                $system_values = [
                    ...
                    'support'        => [
                        'label'        => 'Support',
                        'content'    => _s('Need help? Go to %s and you will get help quickly.', ['%s' => '<a href="https://katchy.com/support" target="_blank">' . _s('Support') . '</a>'])
                    ],
                    'php_version' => [
                ...
                $katchy_urls = [
                    'katchy'                => 'https://katchy.com',
                    _s('Community')                => 'https://katchy.com/community/',
                    _s('Support')                => 'https://katchy.com/support',
                    _s('Documentation')            => 'https://v3-docs.katchy.com',
                    _s('Changelog')                => 'https://katchy.com/releases',
                    _s('Bug tracking')            => 'https://katchy.com/bug-tracking',
                    'GitHub'                     => 'https://github.com/katchy',
                ];
                $katchy_links = [];
                foreach ($katchy_urls as $k => $v) {
                    $katchy_links[] = '<a href="' . $v . '" target="_blank">' . $k . '</a>';
                }

                $system_values['links']['content'] = implode(' · ', $katchy_links);
