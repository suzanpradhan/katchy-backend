...
$isGt3160 = version_compare(Settings::get('katchy_version_installed'), '1.2.0', '>=');
// Not installed
...
if (is_readable(G_APP_PATH . 'katchy-hook.php')) {
    require_once G_APP_PATH . 'katchy-hook.php';
}
...
try {
    if (!isset($hook_before)) {
        $hook_before = function ($handler) {
            ...
            $pageHandle = version_compare(Settings::get('katchy_version_installed'), '1.2.0', '>=') ? 'internal' : 'url_key';
