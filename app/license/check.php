...
/* --------------------------------------------------------------------
  ...
  This file is part of katchy Free.
  https://katchy.com/free

  (c) Rodolfo Berrios <rodolfo@katchy.com>
...
/* --------------------------------------------------------------------
  ...
  check to the eyes of katchy copyright holder and if that happens
  the use of the katchy in the target website will be forbidden.
  
  katchy license check system works like any normal request and
  ...
  stored at katchy.com and that only happens if the complement
  match with the $secret, therefore, it will only match if
  $license is a valid katchy license.
